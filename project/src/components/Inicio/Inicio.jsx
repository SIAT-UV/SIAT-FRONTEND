...
export const Inicio = () => {
    return (
        <>
            ...
            <main>
                <Bienvenida>
                SIAT es un Sistema de Información sobre accidentes de transito en la ciudad de Tuluá. 
                Aquí puedes consultar los registros de accidentes reportados y también registrar un accidente que hayas presenciado para informar a la comunidad. 
                Además, cuentas con otras secciones como un mapa de calor que muestra las zonas con mayor riesgo de accidentes, 
                un panel de control con estadísticas detalladas y una sección de aprendizaje vial con información clave para una conducción más segura.
                </Bienvenida>
                <PanelSecciones>
